...
const runtimeSite = 'https://mihnblog.cc.cd';
...
export default defineConfig({
	...
	integrations: [
		...
		sitemap({
			filter: (page) => {
				if (page === 'https://mihnblog.cc.cd/admin/' || page === 'https://mihnblog.cc.cd/important/') {
					return false;
				}
				return !/^https:\/\/mihnblog\.cc\.cd\/blog\/page\/\d+\/$/.test(page);
			},
		}),
	],
	markdown: {
